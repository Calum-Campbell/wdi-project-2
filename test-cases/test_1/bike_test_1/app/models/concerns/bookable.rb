module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      bike.bookings.end_during(start_time, end_time),
      bike.bookings.start_during(start_time, end_time),
      bike.bookings.happening_during(start_time, end_time),
      bike.bookings.enveloping(start_time, end_time),
      bike.bookings.identical(start_time, end_time)
    ].flatten
